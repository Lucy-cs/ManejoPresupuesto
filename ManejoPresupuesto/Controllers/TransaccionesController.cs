...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController: Controller
    {
        ...
        [HttpGet]
        public async Task<FileResult> ExportarExcelPorMes(int mes, int año) //accion para que el usuario pueda exportar el archivo
        {
        ...
        public async Task<JsonResult> ObtenerTransaccionesCalendario(DateTime start, DateTime end)
        {
            ...
            {
                Title = transaccion.Monto.ToString("N2"),
        ...
        public async Task<IActionResult> Editar(TransaccionActualizacionViewModel modelo)
        {
            ...
            {
                if (Url.IsLocalUrl(modelo.UrlRetorno))
                {
                    return LocalRedirect(modelo.UrlRetorno);
                }
                else
                {
                    return RedirectToAction("Index"); // Redirige a una página segura si la URL no es local
                }
            }
